let chipsTossups = [
  {
    data: {
      tossups: [
        {
          formatted_text:
            "This user of Discord has an animal-themed profile picture with a pastel color scheme. For 10 points, name this Chips Compo user who should go to sleep.",
          answer: "LunacyEcho",
        },
      ],
    },
